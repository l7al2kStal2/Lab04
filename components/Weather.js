    ...
    render() {
        return (
            <View style={styles.container}>
                <ImageBackground source={require("../thunder.jpg")} style={styles.backdrop}>
                    ...
                    <Text style={styles.fontName}>                                   by </Text>
                    <Text style={styles.fontName}>                     Mr.Kritsanachart Thitsisaeng</Text>
                    <Text style={styles.fontName}>                            ID : 5835512097</Text>
                </ImageBackground>
